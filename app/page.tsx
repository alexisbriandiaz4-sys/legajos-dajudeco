    ...
    >
      ...
      <aside
        style={{
          ...
          boxShadow: 'inset -1px 0 0 rgba(59,130,246,0.15)',
        ...
        <div style={{ borderColor: 'var(--border)' }} className="p-2 border-t">
          ...
          {sidebarAbierto && (
            <p
              ...
              className="text-[10px] px-2 mb-1 uppercase tracking-wider"
            >
              Tema
            </p>
          )}
          ...
          {sidebarAbierto && (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] capitalize">{usuario?.rol}</p>
              </div>
            </div>
          )}
      ...
      <main className="flex-1 overflow-auto flex flex-col relative">
        ...
        >
          ...
          <div
            key={vista}
            style={{ animation: 'fadeSlideIn 0.25s cubic-bezier(0.4, 0, 0.2, 1)' }}
          >
